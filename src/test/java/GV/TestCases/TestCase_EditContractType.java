...
public class TestCase_EditContractType {
      WebDriver driver;
      
      
  @Test(dataProvider="EditContractType",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String NewContract ,String contract) throws Throwable {
	  ...
	  //Edit ContractType
	  PageObject_contract_type Edit=PageFactory.initElements(driver, PageObject_contract_type.class);
	  System.out.println("samane");
	  Edit.Edit_Contract_Name(driver, NewContract, contract);
	  driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);  

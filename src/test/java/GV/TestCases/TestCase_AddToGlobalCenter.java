...
public class TestCase_AddToGlobalCenter {
      WebDriver driver;
      
      
  @Test(dataProvider="AddToGlobalCenter",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password, String toDate ,String toDate2) throws Throwable {
	  ...
	  Add.AddToGlobalCenter(driver, toDate, toDate2);
	  driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);  

...
public class TestCase_AddContractType {
      WebDriver driver;
      
      
  @Test(dataProvider="AddContractType",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String contractName ,String contractTariff ,String contractName2 ,String contractTariff2,String contractName3 ,String contractTariff3) throws Throwable {
	  ...
	  //Enter to Contract Page
	  PageObject_MainMenu basic=PageFactory.initElements(driver, PageObject_MainMenu.class);
	  basic.Contract_Icon(driver);
	  driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);  

	  //AddContractType
	  PageObject_contract_type Add=PageFactory.initElements(driver, PageObject_contract_type.class);
	  System.out.println("samane");
	  Add.Add_Contract_Name(driver, contractName, contractTariff, contractName2, contractTariff2, contractName3, contractTariff3);

...
public class TestCase_DeActiveActivContract {
      WebDriver driver;
      
      
  @Test(dataProvider="DeActiveActiveContract",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String NewContract, String activ_deActiv, String activ_deActiv2 ) throws Throwable {
	  ...
	  PageObject_MainMenu Contract=PageFactory.initElements(driver, PageObject_MainMenu.class);
	  Contract.Contract_Icon(driver);
	  driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);  

	  //DeActive Contract
	  PageObject_contract_type DeActive=PageFactory.initElements(driver, PageObject_contract_type.class);
	  DeActive.Active_DeActive(driver, NewContract, activ_deActiv, activ_deActiv2);

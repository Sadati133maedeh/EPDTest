...
public class TestCase_TakhsisInsurance_Add {
  ...
  public void f(String URL ,String UserName ,String Password,String insurance, String fromeDate , String toDate) throws Throwable {
	  ...
	  Add.AddeInsuranceAllocation(driver, insurance, fromeDate, toDate);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  

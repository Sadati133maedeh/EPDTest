...
public class TestCase_EditGlobalServiceAdded {
      WebDriver driver;
      
      
  @Test(dataProvider="EditGlobalServiceAdded",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String globalName ,String globalCode ,String kJarahi ,String kBihooshi,String degree1 ,String degree2,String degree3,String degree4,String fromdate) throws Throwable {
	  ...
	  //Edit Global Service Added
	  PageObject_Global_Services_Peyvand Edit=PageFactory.initElements(driver, PageObject_Global_Services_Peyvand.class);
	  Edit.EditGlobalServiceAdded(driver, globalName, globalCode, kJarahi, kBihooshi, degree1, degree2, degree3, degree4, fromdate);

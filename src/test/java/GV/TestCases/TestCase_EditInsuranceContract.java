...
public class TestCase_EditInsuranceContract {
      WebDriver driver;
      
      
  @Test(dataProvider="EditInsuranceContract",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String Contract ,String model ,String herfeyiPatientShear ,String herfeyiInsurShear, String herfeyiFeranshiz, String technicalPatientShear,String technicalInsurShare, String technicalFeranshiz, String tariff, String patientDiference, String insurDiference,String exteraKInsurShare,String extraKFranshiz,String drugInsurShare,String drugFranshizShare ) throws Throwable {
	  ...
	  //Edit InsuranceContract
	  PageObject_insurance_contract EditInsuranceContract=PageFactory.initElements(driver, PageObject_insurance_contract.class);
	  EditInsuranceContract.EditInsuranceContract(driver, Contract, model, herfeyiPatientShear, herfeyiInsurShear, herfeyiFeranshiz, technicalPatientShear, technicalInsurShare, technicalFeranshiz, tariff, patientDiference, insurDiference, exteraKInsurShare, extraKFranshiz, drugInsurShare, drugFranshizShare);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  

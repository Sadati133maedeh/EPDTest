...
public class TestCaseAddPersionPatient_bornOutOfIranAndFree {
      String nationalCode;
  ...
  @Test(dataProvider="AddPersionPatient_bornOutOfIranAndFree",dataProviderClass=RIS_DataProviders.class)
...
//	  }
	 ...
	 sick.AddPersionPatient_bornOutOfIranAndFree(driver, Name, Family, NameEn, FamilyEn, Father, Avatar, Sex, Tahol, BirthDate, Mahaltavalod, City, Phone, TelPhone,Post, Adress, Email, Bime, Sandogh, BimeDate, Nesbat, Meliat, OldId, CaseComment);
